...
class Globs {
    static let AppName  = "Groceries Shop"
    
    static let BASE_URL = "http://127.0.0.1:3001/api/app/"
    ...
    static let SV_EXPLORE_CATEGORY_ITEMS_LIST = BASE_URL + "explore_category_items_list"
    ...
    static let SV_DELIVERY_ADDRESS_LIST = BASE_URL + "delivery_address"
    static let SV_ADD_DELIVERY_ADDRESS = BASE_URL + "add_delivery_address"
    static let SV_UPDATE_DELIVERY_ADDRESS = BASE_URL + "update_delivery_address"
    static let SV_DELETE_DELIVERY_ADDRESS = BASE_URL + "delete_delivery_address"
    ...
    static let SV_MY_ORDER = BASE_URL + "my_order"
    static let SV_MY_ORDER_DETAIL = BASE_URL + "my_order_detail"
    ...
    static let SV_FORGOT_PASSWORD_REQUEST = BASE_URL + "change_password_request"
...
struct KKey {
    ...
    static let deliverPriceAmount = "deliver_price_amount"
    static let discountAmount = "discount_amount"
    static let userPayPrice = "user_pay_price"
